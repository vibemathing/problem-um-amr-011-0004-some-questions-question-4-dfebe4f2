...
```json
{
  ...
  "problem_contract": {
    ...
    "problem_id": "problem:um-amr-011-0004-some-questions-question-4-dfebe4f2",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-amr-011-0004-91b90e3da5ed",
        "url": "https://www.unsolvedmath.com/problems/AMR-011-0004"
      }
    ],
    "statement": {
      "language": "en",
      "text": "Let $\\Gamma$ be a countable subgroup of $\\operatorname{SL}_2(\\mathbb{Q}_p)$ containing no parabolic elements, and let $\\gamma$ be a random element of $\\operatorname{SL}_2(\\mathbb{Q}_p)$. Show that $\\langle\\Gamma,\\gamma\\rangle$ almost surely contains no parabolic elements.",
      "version": 1
    },
    "title": "Some Questions — Question 4",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "20f700f3886cb30f55a7e2afe2b156eda78bc9cb3246a6d77d7767795e463c99"
}
```
